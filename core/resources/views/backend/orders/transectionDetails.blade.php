...
@section('title_button')
    <a href="{{ route('admin.transections') }}" class="btn bg-gradient-primary">
    ...
    <div class="invoice p-3 mb-3">
        ...
        <div class="row invoice-info">
            <div class="col-sm-4 invoice-col">
                ...
                <b>Status: </b> {{($data->is_paid==1)?'Success':'Pending'}} <br>
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <div class="col-md-12">
                    @if($data->is_paid==0)
                    <p>
                        It's a manual payment. Waiting for admin approval. <br>
                    Status: <span class="badge badge-warning">Pending</span>
                    </p>
                    <a class="btn btn-primary" href="{{route('admin.transections.approval',$data->id)}}"> Approve </a>
                    @else 
                    Status: <span class="badge badge-success">Paid</span>
                    @if($data->user_id != $data->verified_by)
                    <br>
                    Verified by: <b>{{$data->verifier->name ?? ''}}</b>
                    @endif
                    @endif
                </div>
            </div>
