        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-5 border-right">
                    <fieldset>
                        <form action="{{ route('portfolio.categories.store') }}" method="post" id="addNewData">
                            @csrf
                                    ...
                                    <td>
                                        <div class="text-center">
                                            ...
                                            <a class="btn btn-danger btn-xs" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete Category"
                                                                ...
                                                                onclick='resourceDelete("{{ route('portfolio.categories.destroy', $data->id) }}")'>
                                        ...
                                        <div class="modal fade" id="editCategory-{{ $data->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                {!! Form::open(['method' => 'put', 'route' => ['portfolio.categories.update', $data->id]]) !!}
