            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                        ...
                        <a href="{{route('admin.transections')}}" class="small-box-footer">
                            More info
                            <i class="fas fa-arrow-circle-right"></i>
                        </a>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer clearfix">
                            <a href="{{route('admin.transections')}}" class="btn btn-sm btn-secondary float-right">View All Transections</a>
                        </div>
                        <!-- /.card-footer -->
                    </div>
                    <!-- /.card -->
